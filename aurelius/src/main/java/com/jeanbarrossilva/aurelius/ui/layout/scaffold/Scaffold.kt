...
/**
 * Allows for overlaying components (such as a [FloatingActionButton]) to be consistently placed
 * alongside the [content] that's underneath them and vice-versa.
 *
 * @param modifier [Modifier] to be applied to the underlying [Composable].
 * @param floatingActionButton [FloatingActionButton] to be placed at the bottom trailing corner.
 * @param content Content to be shown underneath.
 **/
